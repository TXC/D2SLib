...
namespace D2SImporter.Attributes
{
    ...
    /// Import complex data
    /// </summary>
    /// <param name="callingType">Method signature (<c>Action<Dictionary<string, string>></c></param>
    /// <param name="delegateType">Class to call</param>
    /// <param name="delegateName">Methodname to call</param>
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Struct, AllowMultiple = false, Inherited = true)]
    public class PreImportRowAttribute(Type callingType, Type delegateType, string delegateName) : Attribute
    {
